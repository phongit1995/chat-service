...
import (
	conversationModule "chat-server/internal/modules/conversation"

	"github.com/google/uuid"
)

type ConversationCacheAdapter struct {
	cache *conversationModule.CacheService
}

func NewConversationCacheAdapter(cache *conversationModule.CacheService) *ConversationCacheAdapter {
